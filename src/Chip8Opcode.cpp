...
chip8_opcode::chip8_opcode()
    : code(0)
{}

chip8_opcode::chip8_opcode(uint16_t op)
    : code(op)
{}

uint16_t chip8_opcode::get_addr() const
{
...
uint8_t chip8_opcode::get_kk() const
{
...
bool chip8_opcode::is_cls_opcode() const
{
    return code.opcode == 0x00E0;
}

bool chip8_opcode::is_ret_opcode() const
{
