...
bool chip8_emulator::is_wait() const { return in_wait; }

void chip8_emulator::push_stack(uint16_t val) { rom_stack.push(val); }
...
uint8_t chip8_emulator::get_random() { return distrib(engine); }
